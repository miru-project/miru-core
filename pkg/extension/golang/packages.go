...
func init() {
	...
	// "bytes"
	decs = make(native.Declarations, 65)
	...
	// "crypto/tls"
	decs = make(native.Declarations, 122)
	...
	decs["MLDSA44"] = tls.MLDSA44
	decs["MLDSA65"] = tls.MLDSA65
	decs["MLDSA87"] = tls.MLDSA87
	decs["MLKEM1024"] = tls.MLKEM1024
	...
	// "crypto/x509"
	decs = make(native.Declarations, 116)
	...
	decs["MLDSA"] = x509.MLDSA
	decs["MLDSA44"] = x509.MLDSA44
	decs["MLDSA65"] = x509.MLDSA65
	decs["MLDSA87"] = x509.MLDSA87
	...
	decs["CallMethodsWithLegacySemantics"] = json.CallMethodsWithLegacySemantics
	decs["Compact"] = json.Compact
	decs["Decoder"] = reflect.TypeFor[json.Decoder]()
	decs["DefaultOptionsV1"] = json.DefaultOptionsV1
	decs["Delim"] = reflect.TypeFor[json.Delim]()
	decs["Encoder"] = reflect.TypeFor[json.Encoder]()
	decs["FormatByteArrayAsArray"] = json.FormatByteArrayAsArray
	decs["FormatBytesWithLegacySemantics"] = json.FormatBytesWithLegacySemantics
	decs["FormatDurationAsNano"] = json.FormatDurationAsNano
	...
	decs["MatchCaseSensitiveDelimiter"] = json.MatchCaseSensitiveDelimiter
	decs["MergeWithLegacySemantics"] = json.MergeWithLegacySemantics
	decs["NewDecoder"] = json.NewDecoder
	decs["NewEncoder"] = json.NewEncoder
	decs["Number"] = reflect.TypeFor[json.Number]()
	decs["OmitEmptyWithLegacySemantics"] = json.OmitEmptyWithLegacySemantics
	decs["Options"] = reflect.TypeFor[json.Options]()
	decs["ParseBytesWithLooseRFC4648"] = json.ParseBytesWithLooseRFC4648
	decs["ParseTimeWithLooseRFC3339"] = json.ParseTimeWithLooseRFC3339
	decs["RawMessage"] = reflect.TypeFor[json.RawMessage]()
	decs["ReportErrorsWithLegacySemantics"] = json.ReportErrorsWithLegacySemantics
	decs["StringifyWithLegacySemantics"] = json.StringifyWithLegacySemantics
	decs["SyntaxError"] = reflect.TypeFor[json.SyntaxError]()
	decs["Token"] = reflect.TypeFor[json.Token]()
	decs["Unmarshal"] = json.Unmarshal
	decs["UnmarshalArrayFromAnyLength"] = json.UnmarshalArrayFromAnyLength
	...
	decs["ExtensionEpisode"] = reflect.TypeFor[runtime_2.ExtensionEpisode]()
	...
	decs["FilterDefinitionToProto"] = runtime_2.FilterDefinitionToProto
	...
	decs["ExtensionEpisode"] = reflect.TypeFor[sdk.ExtensionEpisode]()
	...
	decs["StringLen"] = constant.StringLen
	...
	// "go/types"
	decs = make(native.Declarations, 163)
	...
	decs["Hasher"] = reflect.TypeFor[types.Hasher]()
	decs["HasherIgnoreTags"] = reflect.TypeFor[types.HasherIgnoreTags]()
	decs["Id"] = types.Id
	...
	// "net/http"
	decs = make(native.Declarations, 188)
	...
	decs["DefaultMaxHeaderValueCount"] = native.UntypedNumericConst("500")
	...
	decs["NewTestServer"] = httptest.NewTestServer
	...
	// "unicode"
	decs = make(native.Declarations, 309)
	...
	decs["Beria_Erfe"] = &unicode.Beria_Erfe
	...
	decs["Gurung_Khema"] = &unicode.Gurung_Khema
	...
	decs["IDS_Unary_Operator"] = &unicode.IDS_Unary_Operator
	decs["ID_Compat_Math_Continue"] = &unicode.ID_Compat_Math_Continue
	decs["ID_Compat_Math_Start"] = &unicode.ID_Compat_Math_Start
	...
	decs["Kirat_Rai"] = &unicode.Kirat_Rai
	decs["L"] = &unicode.L
	decs["LC"] = &unicode.LC
	...
	decs["Modifier_Combining_Mark"] = &unicode.Modifier_Combining_Mark
	...
	decs["Todhri"] = &unicode.Todhri
	decs["Tolong_Siki"] = &unicode.Tolong_Siki
	decs["Toto"] = &unicode.Toto
	decs["Tulu_Tigalari"] = &unicode.Tulu_Tigalari
	...
	decs["Version"] = native.UntypedStringConst("17.0.0")
