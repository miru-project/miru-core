...
var (
	...
	DownloadsColumns = []*schema.Column{
		...
		{Name: "media_type", Type: field.TypeEnum, Nullable: true, Enums: []string{"unspecified", "hls", "mp4", "torrent", "magnet"}, Default: "unspecified"},
		{Name: "category", Type: field.TypeEnum, Nullable: true, Enums: []string{"unspecified", "video", "manga", "novel"}, Default: "unspecified"},
